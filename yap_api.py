...
class YapApi(object):
    ...
    def call_yap(self, text:str, ip:str):
        ...
        url = f'https://www.langndata.com/api/heb_parser?token=4c50c422eeaeeae2decdcb28f6548c7f'
        # _json='{"text":"  '+text+'  "}'
        ...
        # print("json recrived from yap is: ", r.json())
        return r.json()
